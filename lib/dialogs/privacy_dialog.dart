...
class _PrivacyDialogState extends State<PrivacyDialog> {
  ...
  Future<Map<String , dynamic>> getPrivacyPolicyFromFireStore() async {
    await Firebase.initializeApp();
    final firestoreInstance = FirebaseFirestore.instance;
    DocumentSnapshot document = await firestoreInstance.collection("privacy").doc('privacy_document').get();
  ...
  Widget getPrivacyContent(){
    return FutureBuilder(
      future: getPrivacyPolicyFromFireStore(),
